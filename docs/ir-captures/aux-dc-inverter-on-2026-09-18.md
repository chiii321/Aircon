...
Audit note: the recorded ON label is unverified. The library interprets this frame's power bit as OFF (byte 9 is `0x00`). Preserve this original capture and confirm the label with a fresh capture and physical replay.
