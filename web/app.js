...
function renderOverview() {
  ...
  return `<div class="page overview-page"><div class="overview-brand"><span class="brand-symbol">N</span><span>INUVAIR</span><span class="brand-caption">ROOM CLIMATE</span></div>
