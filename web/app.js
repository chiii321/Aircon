...
function renderOverview() {
  ...
  return `<div class="page overview-page"><div class="overview-brand"><img class="brand-symbol" src="assets/inuvair-logo.png" alt=""><span>INUVAIR</span><span class="brand-caption">ROOM CLIMATE</span></div>
